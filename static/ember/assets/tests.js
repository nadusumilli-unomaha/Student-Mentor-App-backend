...
define('frontend/tests/authenticators/torii.jshint.lint-test', [], function () {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'authenticators/torii.js should pass jshint.\nauthenticators/torii.js: line 4, col 10, \'Ember\' is not defined.\n\n1 error');
  });
});
...
define('frontend/tests/controllers/mentors/index.jshint.lint-test', [], function () {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'controllers/mentors/index.js should pass jshint.\ncontrollers/mentors/index.js: line 47, col 57, Missing semicolon.\n\n1 error');
  });
});
